...
parser.add_argument('-rm', '--reenactment_model', metavar='PATH',
                    default='weights_v2/nfv_msrunet_256_1_2_reenactment_v2.1.pth', help='reenactment model')
parser.add_argument('-cm', '--completion_model', default='weights_v2/ijbc_msrunet_256_1_2_inpainting_v2.pth',
                    metavar='PATH', help='completion model')
parser.add_argument('-bm', '--blending_model', default='weights_v2/ijbc_msrunet_256_1_2_blending_v2.pth',
                    metavar='PATH', help='blending model')
parser.add_argument('-ci', '--criterion_id', default="vgg_loss.VGGLoss('weights_v2/vggface2_vgg19_256_1_2_id.pth')",
