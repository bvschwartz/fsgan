...
import fsgan.utils.jobs as jobs
...
parser.add_argument('-sv', '--run_server', action='store_true', default=False,
...
class FaceSwapping(VideoProcessBase):
    ...
    def finetune(self, source_path, save_checkpoint=True):
        ...
        print('=> swap.py: Finetuning the reenactment generator on: "%s"...' % os.path.basename(source_path))
